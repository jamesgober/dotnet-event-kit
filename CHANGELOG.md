...
### Fixed
- Improved test reliability for cancellation scenarios
...
[Unreleased]: https://github.com/jamesgober/dotnet-event-kit/compare/v1.0.1...HEAD
[1.0.1]: https://github.com/jamesgober/dotnet-event-kit/releases/tag/v1.0.1
